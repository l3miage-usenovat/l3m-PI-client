...
var IconDirective = /** @class */ (function (_super) {
    ...
    IconDirective = __decorate([ __metadata("design:paramtypes", [marker_provider_1.MarkerProvider])
    ], IconDirective);
IconDirective.ɵfac = function IconDirective_Factory(t) { return new (t || IconDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.MarkerProvider)); };
IconDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: IconDirective, selectors: [["yaga-icon"]], inputs: { className: "className", iconUrl: "iconUrl", iconRetinaUrl: "iconRetinaUrl", iconSize: "iconSize", iconAnchor: "iconAnchor", popupAnchor: "popupAnchor", tooltipAnchor: "tooltipAnchor", shadowUrl: "shadowUrl", shadowRetinaUrl: "shadowRetinaUrl", shadowSize: "shadowSize", shadowAnchor: "shadowAnchor" }, outputs: { updateEvent: "update" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(IconDirective, [{
        type: core_1.Directive,
        args: [{
                selector: "yaga-icon"
            }]
    }], function () { return [{ type: ɵngcc1.MarkerProvider }]; }, { className: [{
            type: core_1.Input
        }], iconUrl: [{
            type: core_1.Input
        }], iconRetinaUrl: [{
