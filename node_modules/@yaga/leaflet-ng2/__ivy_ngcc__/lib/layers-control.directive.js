...
var ɵngcc1 = require('./map.provider');
var ɵngcc2 = require('./layers-control.provider');
...
var LayersControlDirective = /** @class */ (function (_super) {
     ...
     */
    LayersControlDirective.prototype._initLayout = function () {
        var _this = this;
        // @ts-ignore
        _super.prototype._initLayout.call(this);
        // Events
        this.getContainer().addEventListener("click", function (event) {
            _this.clickEvent.emit(mouse_event_helper_1.enhanceMouseEvent(event, _this._map));
        });
        this.getContainer().addEventListener("dblclick", function (event) {
            _this.dblclickEvent.emit(mouse_event_helper_1.enhanceMouseEvent(event, _this._map));
        });
        this.getContainer().addEventListener("mousedown", function (event) {
            _this.mousedownEvent.emit(mouse_event_helper_1.enhanceMouseEvent(event, _this._map));
        });
        this.getContainer().addEventListener("mouseover", function (event) {
            _this.mouseoverEvent.emit(mouse_event_helper_1.enhanceMouseEvent(event, _this._map));
        });
        this.getContainer().addEventListener("mouseout", function (event) {
    ...
    ], LayersControlDirective.prototype, "displayChange", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "zIndexChange", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "positionChange", void 0);
    __decorate([
        core_1.Output("add"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "addEvent", void 0);
    __decorate([
        core_1.Output("remove"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "removeEvent", void 0);
    __decorate([
        core_1.Output("click"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "clickEvent", void 0);
    __decorate([
        core_1.Output("dblclick"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "dblclickEvent", void 0);
    __decorate([
        core_1.Output("mousedown"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "mousedownEvent", void 0);
    __decorate([
        core_1.Output("mouseover"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "mouseoverEvent", void 0);
    __decorate([
        core_1.Output("mouseout"),
        __metadata("design:type", core_1.EventEmitter)
    ], LayersControlDirective.prototype, "mouseoutEvent", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], LayersControlDirective.prototype, "opacity", null);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [Boolean])
    ], LayersControlDirective.prototype, "display", null);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String),
        __metadata("design:paramtypes", [String])
    ], LayersControlDirective.prototype, "position", null);
    __decorate([
        core_1.Input(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], LayersControlDirective.prototype, "zIndex", null);
    LayersControlDirective = __decorate([ __metadata("design:paramtypes", [map_provider_1.MapProvider,
            layers_control_provider_1.LayersControlProvider])
    ], LayersControlDirective);
LayersControlDirective.ɵfac = function LayersControlDirective_Factory(t) { return new (t || LayersControlDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.MapProvider), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.LayersControlProvider)); };
LayersControlDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: LayersControlDirective, selectors: [["yaga-layers-control"]], inputs: { opacity: "opacity", display: "display", position: "position", zIndex: "zIndex" }, outputs: { displayChange: "displayChange", zIndexChange: "zIndexChange", positionChange: "positionChange", addEvent: "add", removeEvent: "remove", clickEvent: "click", dblclickEvent: "dblclick", mousedownEvent: "mousedown", mouseoverEvent: "mouseover", mouseoutEvent: "mouseout" }, features: [ɵngcc0.ɵɵProvidersFeature([layers_control_provider_1.LayersControlProvider]), ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(LayersControlDirective, [{
        type: core_1.Directive,
        args: [{
                providers: [layers_control_provider_1.LayersControlProvider],
                selector: "yaga-layers-control"
            }]
    }], function () { return [{ type: ɵngcc1.MapProvider }, { type: ɵngcc2.LayersControlProvider }]; }, { opacity: [{
            type: core_1.Input
        }], display: [{
            type: core_1.Input
        }], position: [{
