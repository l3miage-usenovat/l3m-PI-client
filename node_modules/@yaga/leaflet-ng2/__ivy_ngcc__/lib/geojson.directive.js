...
var GeoJSONDirective = /** @class */ (function (_super) {
    ...
    GeoJSONDirective = __decorate([ __param(0, core_1.SkipSelf()),
...
GeoJSONDirective.ɵfac = function GeoJSONDirective_Factory(t) { return new (t || GeoJSONDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.LayerGroupProvider, 4), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.LayerGroupProvider), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.LayerProvider)); };
GeoJSONDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: GeoJSONDirective, selectors: [["yaga-geojson"]], inputs: { data: "data", filter: "filter", pointToLayer: "pointToLayer", styler: "styler", defaultStyle: "defaultStyle" }, outputs: { dataChange: "dataChange", addEvent: "add", removeEvent: "remove", popupopenEvent: "popupopen", popupcloseEvent: "popupclose", tooltipopenEvent: "tooltipopen", tooltipcloseEvent: "tooltipclose", clickEvent: "click", dblclickEvent: "dblclick", mousedownEvent: "mousedown", mouseoverEvent: "mouseover", mouseoutEvent: "mouseout", contextmenuEvent: "contextmenu", onEachFeatureEvent: "onEachFeature" }, features: [ɵngcc0.ɵɵProvidersFeature([layer_group_provider_1.LayerGroupProvider, layer_provider_1.LayerProvider]), ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GeoJSONDirective, [{
        ...
        args: [{
            ...
            }] }, { type: ɵngcc1.LayerGroupProvider }, { type: ɵngcc2.LayerProvider }]; }, { data: [{
            type: core_1.Input
        }], filter: [{
            type: core_1.Input
        }], pointToLayer: [{
