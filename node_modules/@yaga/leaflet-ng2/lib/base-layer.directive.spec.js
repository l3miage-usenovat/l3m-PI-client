...
describe("Base-Layer Directive", function () {
    ...
    describe("[caption]", function () {
        it("should be changed in Leaflet when changing in Angular", function (done) {
            ...
            layerControlProvider.ref = {
                ...
                addBaseLayer: function (ref, caption) {
        ...
        it("should be readable", function () {
            ...
            chai_1.expect(baseLayer.caption).equal(val);
        });
    });
});
//# sourceMappingURL=base-layer.directive.spec.js.map