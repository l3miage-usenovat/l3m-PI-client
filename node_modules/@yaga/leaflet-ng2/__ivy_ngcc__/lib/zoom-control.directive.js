...
var ZoomControlDirective = /** @class */ (function (_super) {
    ...
    ZoomControlDirective = __decorate([ __metadata("design:paramtypes", [map_provider_1.MapProvider])
    ], ZoomControlDirective);
ZoomControlDirective.ɵfac = function ZoomControlDirective_Factory(t) { return new (t || ZoomControlDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.MapProvider)); };
ZoomControlDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ZoomControlDirective, selectors: [["yaga-zoom-control"]], inputs: { opacity: "opacity", display: "display", position: "position", zIndex: "zIndex", zoomInText: "zoomInText", zoomInTitle: "zoomInTitle", zoomOutText: "zoomOutText", zoomOutTitle: "zoomOutTitle" }, outputs: { displayChange: "displayChange", zIndexChange: "zIndexChange", positionChange: "positionChange", addEvent: "add", removeEvent: "remove", clickEvent: "click", dblclickEvent: "dblclick", mousedownEvent: "mousedown", mouseoverEvent: "mouseover", mouseoutEvent: "mouseout" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ZoomControlDirective, [{
