...
var TooltipDirective = /** @class */ (function (_super) {
    ...
    TooltipDirective = __decorate([ __param(1, core_1.Inject(core_1.ElementRef)),
        __metadata("design:paramtypes", [layer_provider_1.LayerProvider,
            core_1.ElementRef])
    ], TooltipDirective);
TooltipDirective.ɵfac = function TooltipDirective_Factory(t) { return new (t || TooltipDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.LayerProvider), ɵngcc0.ɵɵdirectiveInject(core_1.ElementRef)); };
TooltipDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: TooltipDirective, selectors: [["yaga-tooltip"]], inputs: { content: "content", opened: "opened", lat: "lat", lng: "lng", position: "position", opacity: "opacity", className: "className", pane: "pane", interactive: "interactive", sticky: "sticky", direction: "direction", permanent: "permanent", offset: "offset" }, outputs: { contentChange: "contentChange", openedChange: "openedChange", latChange: "latChange", lngChange: "lngChange", positionChange: "positionChange", opacityChange: "opacityChange", openEvent: "open", closeEvent: "close" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TooltipDirective, [{
        type: core_1.Directive,
        args: [{
                selector: "yaga-tooltip"
            }]
    }], function () { return [{ type: ɵngcc1.LayerProvider }, { type: ɵngcc0.ElementRef, decorators: [{
                type: core_1.Inject,
